    ...
    <PageTemplate title='Project Detail - Your Tech Partner'>
      ...
      <section className="grid grid-cols-1 gap-8 md:grid-cols-2">
        <aside data-aos="fade-up-right">
          <ImageCard imageUrl="/images/projects/ralphlauren-banner.png" title='Ralph Lauren E-commerce Website' bottomSquareSize="big" height={400} />
        </aside>
        <aside className="grid gap-12 place-content-center" data-aos="fade-up-left">
          <Text
            textStyle="SectionParagraph"
            value="Ralph Lauren website is a massively complicated e-commerce site where it is combine distinct content management, order management, warehouse and product management system."
          />
          <div className="grid gap-6">
            ...
            <div className="grid gap-2">
              ...
              <Text value="Ralph Lauren" textStyle="ProjectDetailValue" />
            </div>
            <div className="grid gap-2">
...
export default RalphLaurenProjectDetail
