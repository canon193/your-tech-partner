...
const UiUxDesignPage = () => {
  ...
  const features: FeatureCardProps[] = [
    ...
    },
    {
      ...
      description: `We suggest content create which you could apply SEO, creative techniques.`,
      icon: <FiCode />,
    },
    {
  ...
  return (
    <PageTemplate title="Service Detail - Your Tech Partner">
      <section className="grid place-items-center">
        <div className="sm:w-10/12 md:w-8/12 lg:w-6/12 text-center" data-aos="zoom-in-up">
          <PageSentence
            badge="UI/UX DESIGN"
            title="Convey your ideas to realistic but magnificent interface"
          />
        </div>
      </section>
      <LineDivider />
      <section className="grid grid-cols-1 place-items-center gap-8 lg:grid-cols-2 lg:gap-5 ">
        <aside className="w-full sm:w-10/12 md:w-8/12 lg:w-full" data-aos="fade-up-right">
          <figure className="w-full h-[450px] relative">
            <Image
              src={'/images/services/ui-ux-design/UIUX-Design.png'}
              layout="fill"
              objectFit="fill"
              alt="UI/UX DESIGN"
            />
