    ...
    <PageTemplate>
      ...
      <section className="grid place-items-center" data-aos="fade-up">
          <div className="prose mx-auto max-w-5xl rounded-sm bg-white py-12 px-4 shadow-md sm:px-16">
            ...
            <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Your Tech Partner LLC, 47/31 Nguyen Tu Gian Street, Go Vap District, Ho Chi Minh City.</p>
            </li>
            <li>
            ...
            <li>
            <p><strong>Website</strong> refers to Your Tech Partner, accessible from <a href="https://your-tech-partner.com" rel="noreferrer" target="_blank">https://your-tech-partner.com</a></p>
            </li>
            <li>
            ...
            <ul>
            <li>By email: support@your-tech-partner.com</li>
            </ul>
          </div>
      </section>
    </PageTemplate>
